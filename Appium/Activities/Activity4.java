...
public class Activity4 {
    ...
    public void addContact() {
        ...
        driver.findElementByXPath("//android.widget.EditText[@text='First name']").sendKeys("Sagar");
        driver.findElementByXPath("//android.widget.EditText[@text='Last name']").sendKeys("Sharma");
        driver.findElementByXPath("//android.widget.EditText[@text='Phone']").sendKeys("22391284782");
        ...
        Assert.assertEquals(contactName, "Sagar Sharma");
    }
